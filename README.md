![Qwiic BMP581 - Python Package](docs/images/gh-banner.png "qwiic BMP581 Python Package")
...
```sh
mprmeote mip install github:sparkfun/qwiic_bmp581_py@examples
```
...
See the examples directory for more detailed use examples and [examples/README.md](https://github.com/sparkfun/qwiic_bmp581_py/blob/main/examples/README.md) for a summary of the available examples.
